    ...
    <div class="card ">
        ...
        <div class="card-block p-b-0">
            ...
            <div class="alert alert-danger">
                <ul>
                    <li>{!! \Session::get('failure') !!} <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span></li>
                </ul>
            </div>
            @endif
        <form action="{{ route('usersavemessage') }}" method="POST">
            @csrf
                      <div class="modal-body">
                      
                      <div class="form-group">
                          <label class="required">Subject</label> 
                          <input type="text" name="subject" required autofocus="" id="ember1057" class="form-control-modal ember-text-field ember-view">
                        </div>
                        <div class="form-group">
                          <label class="required">Message</label> 
                          <textarea type="text" style="resize: none;min-height: 150px;" name="message" required autofocus="" id="ember1057" class="form-control-modal ember-text-field ember-view"></textarea>
                        </div>
                       
                      </div>
                      <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" data-submit="modal" id="btnContactUs">Send</button>
