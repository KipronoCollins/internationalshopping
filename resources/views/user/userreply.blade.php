                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="nav navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item">
                                                    <a class="nav-link btn btn-success mx-2" href=" {{ route('contactsupport') }} " style="color:white">
          ...
          <div class="col-md-8 my-5 m-auto">
                <div class="card ">
                    ...
                    <div class="card-block p-b-0">
                          <form action=" {{ route('usersavereply') }} " method="POST">
                                @csrf
                                <input type="hidden" name="id" id="id" value=" {{ $id }} ">
                                  <div class="modal-body">
                                        <div class="form-group">
                                                <label class="required"><strong>From</strong></label> 
                                                <input type="text"  name="sender" required autofocus="" id="sender" class="form-control-modal ember-text-field ember-view"  value="Administrator"></input>
                                              </div>
                                    <div class="form-group">
