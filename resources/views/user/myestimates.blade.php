                            ...
                            <ul class="nav flex-column">
                                    <li class="nav-item">
                                          ...
                                          <li class="nav-item">
                                            ...
                                            <a href="{{route('myestimates')}}" class="nav-link active">
                        ...
                        <div class="card-block p-b-0">
                            <div class="table-responsive" >
                                <table class="table table-hover m-b-0" id="example">
                                    ...
                                    <tbody>
                                            @if($estimateNo != null)
                                            @for ($i = 0; $i < count($estimateNo); $i++)
                                            <tr class="myest"  onclick="DoNav('{{ route('approveestimate', ['eid'=>$estimateNo[$i]]) }}');">
                                                <td>{{ $t = $i+1 }} </td>
                                                <td>{{ $estimateNo[$i] }}</td>
                                                <td>{{ $date[$i] }} </td>
                                                <td>{{ $status[$i] }}</td>
