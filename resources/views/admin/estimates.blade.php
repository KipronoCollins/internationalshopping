...
<!-- Sidebar end-->
        ...
        <div class="col-md-12">
                <div class="topnav mb-3">
                        <a>Looking for a particular estimate?</a>
                        
                        <div class="search-container mb-2 ml-2 mr-2">
                        <form action="{{ route('searchestimate') }}" method="POST">
                          {{ csrf_field() }}
    ...
    <div class="alert alert-danger">
        <ul>
            <li>The record you searched for does not exist or is closed</li>
        </ul>
    </div>
@endif
                        ...
                        <table class="table table-hover m-b-0" id="example">
                            ...
                            <tbody>
                              ...
                              @for ($i = 0; $i < count($eid); $i++)
                                <tr onclick="DoNav('{{ route('changeestimate', ['iid'=>$eid[$i]]) }}');">
                                <td>{{ $t = $i + 1 }}</td>
