                    ...
                    <ul class="nav flex-column">
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                  ...
                                  <li class="nav-item">
                                    <a class="nav-link  active" href="{{route('managereviews')}}">
                    ...
                    <tr>
                           ...
                           <td class="" style="max-width: 150px;">
                            {{ $item->Review }}tt
                                    ...
                                    <td>
                                    <form action="{{ route('reviewstatus') }}" style="display:inline-block" method="POST">
                                        @csrf
    <input type="hidden" id="status" name="status" value="post">
    <input type="hidden" id="id" name="id" value=" {{ $item->id }} ">
    <input type="submit" class="btn btn-success mr-3" value="POST">
    </form>
    <form action="{{ route('reviewstatus') }}" style="display:inline-block" method="POST">
        @csrf
            <input type="hidden" id="status" name="status" value="withhold">
            <input type="hidden" id="id" name="id" value=" {{ $item->id }} ">
            <input type="submit" class="btn btn-danger ml-3" value="WITHHOLD">
            </form>
                                        </td>
