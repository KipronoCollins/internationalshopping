                        ...
                        <div class="sidebar-header" style="margin:auto">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                  ...
                                  <li class="nav-item">
                                      <a class="nav-link  active" href="{{route('displayadmininbox')}}">
          ...
          <div class="col-md-8 my-5 m-auto">
                <div class="card ">
                    ...
                    <div class="card-block p-b-0">
                          <form action=" {{ route('adminsavereply') }} " method="POST">
                            @csrf
                                  <div class="modal-body">
                                        <div class="form-group">
                                                <label class="required"><strong>From</strong></label> 
                                                <input type="text"  name="sender" required autofocus="" id="sender" class="form-control-modal ember-text-field ember-view" value=" {{ $name }} "></input>
                                              </div>
                                    <div class="form-group">
                                        <label class="required"><strong>Subject</strong></label> 
                                        <input type="text"  name="subject" required autofocus="" id="subject" class="form-control-modal ember-text-field ember-view" value=" {{ $subject }} "></input>
                                      </div>
                                  
                                    <div class="form-group">
                                      <label class="required"><strong>Message</strong></label> 
                                      <textarea type="text" style="resize: none;min-height: 150px;" name="message" required autofocus="" id="message" class="form-control-modal ember-text-field ember-view"> {{ $message }} </textarea>
                                      <input type="hidden" name="id" id="id" value=" {{ $id }} ">
                                    </div>
                                    
                                    <div class="form-group">
                                            <label class="required"><strong>Reply</strong></label> 
                                            <textarea type="text" style="resize: none;min-height: 150px;" name="reply" required autofocus="" id="reply" class="form-control-modal ember-text-field ember-view"></textarea>
                                          </div>
                                  </div>
                                  <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary" data-submit="modal" id="btnContactUs">Reply</button>
