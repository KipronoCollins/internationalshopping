            ...
            <form action=" {{ route('adminedituser') }} " method="POST">
                @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input required name="email" type="email" autofocus="" id="email" class="form-control-modal ember-text-field ember-view" value=" {{ $email }} ">
                      <input type="hidden" name="id" id="id" value=" {{  $id }} ">
                    </div>
                    <div class="form-group">
                        <label class="required">Password</label> 
                        <input type="password" name="password"  id="password" class="form-control-modal ember-text-field ember-view">
                      </div>
                      <div class="form-group">
                        <label class="required">Confirm Password</label> 
                        <input type="password" name="password_confirmation" id="password-confirm" class="form-control-modal ember-text-field ember-view">
                      </div>
                     
                    </div>
                    <div class="modal-footer">
                      <button type="submit" class="btn btn-primary" data-submit="modal" id="btnContactUs">Save</button>
