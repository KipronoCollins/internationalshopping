    ...
    <div class="row">
       <div class=" company-logo" style="width:70%;justify-content:center;display:flex;align-content:center;">
          <a href="https://avechi.com">
            <img src="{{ asset('../images/logo2.png') }}"  class="mx-2 my-3" style="border:0;width:40%">
          </a>
       </div>
          ...
          <div id="Login" >
              ...
              <div style="margin-bottom:40px;margin-top: 20px; border-radius: 25px; ">
                <span style="font-weight:-100;font-size: 26px;">
                  <span style="color:#ffffff;font-size: 30px;">Reset password</span>
                </span>
              </div>
              <div class="container" >
                  <div class="row px-2"  style="display:flex;align-items: center;justify-content: center;">
                    ...
                    <div class="col-8">
                      <center>
                      <input style="margin-bottom: 10px;border-radius: 25px" id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $email ?? old('email') }}"
                ...
                <div class="container">
                    <div class="row px-2" style="display:flex;align-items: center;justify-content: center;">
                      ...
                      <div class="col-8" style="display:flex;align-items: center;justify-content: center;" >
                        <input style="float:left;margin-bottom: 10px;border-radius: 25px;
                        color:red" id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="&#xf084;     Password" required>
                  ...
                  <div class="container">
                    <div class="row px-2" style="display:flex;align-items: center;justify-content: center;">
                      ...
                      <div class="col-8" style="display:flex;align-items: center;justify-content: center;" >
                        <input style="float:left;margin-bottom: 20px;border-radius: 25px;
                        color:red" id="password-confirm" type="password" class="form-control" name="password_confirmation"  placeholder="&#xf084;     Confirm password" required>
                      </div>
                    </div>
                  </div>
