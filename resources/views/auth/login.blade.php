            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="container" >
                  <div class="row px-2"  style="display:flex;align-items: center;justify-content: center;">
                    ...
                    <div class="col-8">
                      <center>
                        <input style="display:block;margin-bottom: 10px;border-radius: 25px" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" name="email"
                        placeholder="&#xf0e0;    Email" required autofocus>
                      </center>
                        @if ($errors->has('email'))
                        <div class="invalid-feedback" role="alert" style="display:flex;align-items: center;justify-content: center;">
                ...
                <div class="container">
                  <div class="row px-2" style="display:flex;align-items: center;justify-content: center;">
                    ...
                    <div class="col-8" style="display:flex;align-items: center;justify-content: center;" >
                      ...
                      color:red" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password"
              ...
              <div style="margin-bottom:20px;margin-top: 10px; border-radius: 25px; ">
                    ...
                    <span style="color:#ffffff;font-size: 20px;">or login with</span>
                  
                </div>  

              <div class="container" style="width:95%;text-align: center;display:flex;align-items: center;justify-content: center;">
                <a href="{{ url('/login/google') }}"  class="btn-google m-b-10">
                  <img src="../images/icon-google.png" alt="GOOGLE">
                  Google
                </a>
                </div>
                <div class="text-center w-full p-t-115 mb-2">
                    <span class="txt1">
