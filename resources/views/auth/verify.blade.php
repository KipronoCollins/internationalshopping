...
<body class="cover">
  ...
  <div class="container-fluid " style="background-color:white;">
    <div class="row">
       <div class=" company-logo" style="width:60%;justify-content:center;display:flex;align-content:center;">
          <a href="https://avechi.com">
            <img src="../images/logo2.png"  class="mx-2 my-3" style="border:0;width:40%">
          </a>
       </div>
       <div class=" company-top" style="width:20%;">
       ...
       <div class=" company-top" style="width:20%;">
        ...
        <h5 class="mt-3 mt-md-4 mt-lg-4" style="color: red;">Logout</h5>
    </a>
    ...
    <!-- Wrap the rest of the page in another container to center all the content. -->
      ...
      <div class="responsive container " style="  height:100%; justify-content: center;
        ...
        <div class=" container-fluid r text-center px-0 my-4" style="background-color: white;border-top-right-radius:80px;border-bottom-left-radius:80px;">
            ...
            <form>
              <div style="margin-bottom:40px;margin-top: 20px; border-radius: 25px; ">
                <span style="font-weight:-100;font-size: 26px;">
                  <span style="color:red;font-size: 24px;">Verify Your Email Address
                    Before proceeding, kindly check your email for a verification link. If you did not receive the email, <a href="{{ route('verification.resend') }}">click here to request another.</a></span>
                </span>
              </div>
