    ...
    <div class="wrapper" style="margin-bottom: 0;">
        ...
        <nav id="sidebar" style="margin-top: 0;">
            <div  class="sidebar-sticky">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{route('displayaccounts')}}">
                    <i class="fa fa-users" aria-hidden="true"></i>
                    User Accounts
                  </a>
                </li>
                <li class="nav-item">
                        <a class="nav-link  active" href="{{route('displayadmins')}}">
                          <i class="fa fa-users" aria-hidden="true"></i>
                          Admin Accounts
                        </a>
                      </li>
      ...
      <div class="card-block p-b-0">
            <form action=" {{ route('editadmin') }} " method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input required name="username" type="text" autofocus="" id="ember1056" class="form-control-modal ember-text-field ember-view" value=" {{ $username }} ">
